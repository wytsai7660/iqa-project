# This script takes the output CSV of process_liqe_labels.py for the CSIQ
# dataset and adds a column named "reference" that contains filenames inside
# datasets/csiq/images/reference-images that identify the undistorted reference
# image of each row. The filenames of the reference images are obtained by
# parsing the filenames of the distorted images.
...
def main(args: Namespace):
    ...
    labels_data_frame["reference"] = labels_data_frame.index.str.split(".").str[0] + ".png"
    labels_data_frame.to_csv(args.output_path)

if __name__ == "__main__":
    argument_parser = ArgumentParser(
        formatter_class=ArgumentDefaultsHelpFormatter,
        description="This script takes the output CSV of process_liqe_labels.py for the CSIQ dataset and adds a column named \"reference\".",
        epilog="For more information, see the comment at the top of this script."
    )
    _ = argument_parser.add_argument("labels_path",
        help="The output CSV of process_liqe_labels.py for the CSIQ dataset.")
